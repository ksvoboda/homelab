...
echo "Step 4: Downloading kube-vip manifest..."

sudo curl -OL /home/kube/kube-vip.yaml https://raw.githubusercontent.com/ksvoboda/homelab/refs/heads/main/setup/k3s/kube-vip-deamonset-yaml

echo "step 5: Applying kube-vip manifest..."

sudo kubectl apply -f /home/kube/kube-vip.yaml

check_status "kubectl apply"
...
echo "Step 6: Setting KUBECONFIG path..."
